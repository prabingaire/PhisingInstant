...
banner() {
	cat <<- EOF
		...
		${ORANGE}      | |                                
		${ORANGE}      |_|                ${RED}Version : 1.1

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Prabin Gaire (@prabingaire)${WHITE}
	EOF
}
...
about() {
	...
	cat <<- EOF
		...
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/prabingaire
		${GREEN}Social   ${RED}:  ${CYAN}https://instagram.com/prabingaire_
